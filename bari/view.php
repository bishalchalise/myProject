...
include('login_user\auth_session.php');
?>
        ...
        <table class="table">
            ...
            <tr>
                <thead>
                    ...
                    <th>  <div>
       <button class="btn-danger" aria-label="Basic mixed styles example"><a style="text-decoration: none; color: white; " href="login_user\logout.php">Logout</a></button>
